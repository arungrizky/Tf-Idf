...
dataset<-read_excel("D:/SimplyAnalytics/Dataset/SMSDataset_SimplyAnalytics.xlsx",sheet="Sheet1")
...
text(x=bp, y=d_tfidf[1:10,]$freq, labels=round(d_tfidf[1:10,]$freq,0), pos=1,family = "sans",col="#ffffff",font=1,cex=1)
...
text(x=bp, y=d_normal[1:10,]$freq, labels=round(d_normal[1:10,]$freq,0), pos=1,family = "sans",col="#ffffff",font=1,cex=1)
